...
build args
'''
semsam_cfg = "/content/SoM/configs/semantic_sam_only_sa-1b_swinL.yaml"
seem_cfg = "/content/SoM/configs/seem_focall_unicl_lang_v1.yaml"
...
with demo:
    ...
    with gr.Row():    
        example = gr.Examples(
            examples=[
                ["/content/SoM/examples/ironing_man.jpg"],
            ],
            inputs=image,
        ...
        example = gr.Examples(
            examples=[
                ["/content/SoM/examples/ironing_man_som.png"],
            ],
            inputs=image,
            cache_examples=False,
