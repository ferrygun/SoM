# https://github.com/UX-Decoder/Segment-Everything-Everywhere-All-At-Once/blob/v1.0/utils/distributed.py
# /usr/local/lib/python3.10/dist-packages/seem/utils/distributed.py
